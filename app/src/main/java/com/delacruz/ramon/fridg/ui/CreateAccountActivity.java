...
import com.delacruz.ramon.fridg.models.User;
...
public class CreateAccountActivity extends AppCompatActivity implements View.OnClickListener {
                ...
                mFirebaseRef.authWithPassword(email, password, new Firebase.AuthResultHandler() {
                    ...
                    public void onAuthenticated(AuthData authData) {
                        if (authData != null) {
                            ...
                            Intent intent = new Intent(CreateAccountActivity.this, PantryActivity.class);
    ...
    private boolean isValidPassword(String password, String confirmPassword) {
        if (password.length() < 6) {
            mPasswordEditText.setError("Please create a password that is at least six characters in length");
            return false;
